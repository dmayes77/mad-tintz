  ...
  sections: [
    {
      title: "Email",
      description:
        "For inquiries, reach out to us anytime at your convenience.",
      linkText: business.email,
    ...
    },
    {
      ...
      linkText: `+1 ${business.phone}`,
      linkHref: `tel:${business.phone}`,
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
  ...
  return (
    <div className="grid grid-cols-1 gap-6 laptop:grid-cols-3">
      {content.sections.map((section, idx) => (
        ...
        >
          {section.icon}
          <h3 className="text-accent font-semibold tracking-wide">
            {section.title}
          </h3>
          <p>{section.description}</p>
          <NextLink href={section.linkHref} className="underline">
            {section.linkText}
          </NextLink>
        </div>
      ))}
